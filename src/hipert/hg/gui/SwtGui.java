...
import hipert.hg.frontend.amalthea.AmaltheaParser;
...
//						    System.out.println(interfaces[0].getName());
	...
	public SwtGui()
	{
		try
		{
			...
			this.frontends.add(new AmaltheaParser());
	...
	protected void createContents() {
		...
		int i = 0;
		for (Iterator<IBackend> iterator = backends.iterator(); iterator.hasNext();) {
...
//		}
	...
	{  
		...
		parser.Parse(this.dags, modelTempFile, this);
	...
	{
		return this.comboScheduling.getItem(this.comboScheduling.getSelectionIndex());
	}

	@Override
	public String getPartitioning() {
		return  this.comboPartitioning.getItem(this.comboPartitioning.getSelectionIndex());
	}

	@Override
	public String getStep() {
		return this.comboStep.getItem(this.comboStep.getSelectionIndex());
	}

	@Override
	public String getMemoryPattern() {
		if(btnSparse.getSelection())
			return "sparse";
		if(btnPrem.getSelection())
			return "prem";
	...
	@Override
	public String getMemoryStrideType() {
		if(this.btnStrideSequential.getSelection())
			return "sequential";
		if(this.btnStrideRandom.getSelection())
			return "random";
	...
	public String getMemoryStride() {
		return this.comboStride.getItem(this.comboStride.getSelectionIndex());
	}
}
